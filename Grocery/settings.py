...
SECRET_KEY = "django-insecure-awnx9mb5u)5ei4th5vs8n1fuh$hp4o_^6r*ch-pj%uu-of$^h9"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(BASE_DIR,'GroceryPrivate/Template/')
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'GroceryPrivate/Static')
]
